...
if($colComboMaterias>0){
    ...
    $selec="<form name=\"form\" id=\"form\" method=\"post\" action=\"p/pSeguimientoMateriaPadres.php\">\n";
...
//
$makeEjercicios=$bd->query("select * from parciales where idCurso='".$filaCurso["id"]."' limit ".$limiteInferior.",".$limiteSuperior.";");
