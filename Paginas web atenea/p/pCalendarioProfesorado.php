...
$consulta="select * from agenda where tipo='profesorado' and month(fecha)=".$mesActual." and year(fecha)=".$anyoActual." order by fecha asc;";
...
if($col>0){
    do{
        ...
        $salida.="<div class=\"bloque_A3\">\n";
        $salida.="<div class=\"bloqueA3_cab\">".$fecha."</div>\n";
...
for($i=0;$i<12;$i++){
    ...
    $makeMes=$bd->query("select * from agenda where tipo='profesorado' and month(fecha)='".$mesHoy."';");
