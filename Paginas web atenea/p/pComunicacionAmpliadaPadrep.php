...
$salida.="<p>";
$dir1="atenea/admin/archivos/comunicacionesp/d1/".$filaQ["id"];
if(is_dir($dir1)){
    $open1=opendir($dir1);
...
$dir2="atenea/admin/archivos/comunicacionesp/d2/".$filaQ["id"];
if(is_dir($dir2)){
    $open2=opendir($dir2);
...
$dir3="atenea/admin/archivos/comunicacionesp/d3/".$filaQ["id"];
if(is_dir($dir3)){
    $open3=opendir($dir3);
