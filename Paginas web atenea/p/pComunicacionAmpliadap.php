...
$makeDel=$bd->query("delete from comsp where idComunicacion='".$com."' and idAlumno='".$id."';");
...
$makeQ=$bd->query("select * from comunicacionesp where id='".$com."';");
$filaQ=$bd->fil($makeQ);
...
$dir1="admin/archivos/comunicacionesp/d1/".$filaQ["id"];
if(is_dir($dir1)){
    $open1=opendir($dir1);
    ...
    $ruta1=$dir1."/".$archivo1;
    $salida.="<div class=\"enlaces\"><a href=\"".$ruta1."\" target=\"_blank\">Link del Documento</a><br />\n";
}
$dir2="admin/archivos/comunicacionesp/d2/".$filaQ["id"];
if(is_dir($dir2)){
    $open2=opendir($dir2);
    ...
    $ruta2=$dir2."/".$archivo2;
    $salida.="<div class=\"enlaces\"><a href=\"".$ruta2."\" target=\"_blank\">Link del Documento</a><br />\n";
}
$dir3="admin/archivos/comunicacionesp/d3/".$filaQ["id"];
if(is_dir($dir3)){
    $open3=opendir($dir3);
    ...
    $ruta3=$dir3."/".$archivo3;
    $salida.="<div class=\"enlaces\"><a href=\"".$ruta3."\" target=\"_blank\">Link del Documento</a><br />\n";
}
if($filaQ["enlace"]!=""){
