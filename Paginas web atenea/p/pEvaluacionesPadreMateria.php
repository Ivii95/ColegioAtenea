...
if($colComboMaterias>0){
    ...
    $selec="<form name=\"form\" id=\"form\" method=\"post\" action=\"p/pMateriaEvaluacionPadres.php\">\n";
...
//
$makeEjercicios=$bd->query("select * from notasevaluaciones where idCurso='".$filaCurso["id"]."' and idAlumno='".$id."' and idMateria='".$mama."' limit ".$limiteInferior.",".$limiteSuperior.";");
$filaEjercicios=$bd->fil($makeEjercicios);
$colEjercicios=$bd->col($makeEjercicios);

$makeTotalEjercicios=$bd->query("select * from notasevaluaciones where idCurso='".$filaCurso["id"]."' and idAlumno='".$id."'  and idMateria='".$mama."';");
...
if($colEjercicios>0){
    ...
    do{
        ...
        $b.="<div class=\"cab_observ_seg3\">Observaciones del Tutor para los padres/tutores legales del alumno:</div>\n
        <div class=\"cab_observ_seg4\">".$obs2."</div>\n";
        $b.="</div>\n";
