<?php
require $_SERVER['DOCUMENT_ROOT'].'/colegio/wordpress/atenea/admin/class/bd.php';
require $_SERVER['DOCUMENT_ROOT'].'/colegio/wordpress/atenea/admin/class/fecha.php';
require $_SERVER['DOCUMENT_ROOT'].'/colegio/wordpress/atenea/admin/class/escalarImagenes.php';
$bd=new bd();
...
if($colEjercicios>0){
    do{
        ...
        $b.="<div class=\"cab_observ_ev3\">Observaciones del Tutor para los padres/tutores legales del alumno:</div>\n
        <div class=\"cab_observ_ev4\">".$obs2."</div>\n";
        $b.="</div>\n";
        $b.="</div>\n";
