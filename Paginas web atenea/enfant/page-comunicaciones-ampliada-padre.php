...
<?php }else{ ?>
	 ...
	 <?php 
			if($_SESSION["tipo"]=="padre"){
	 		...
	 		if(!$_GET["per"]){
				require $_SERVER['DOCUMENT_ROOT'].'/atenea/p/pComunicacionAmpliadaPadre.php'; 
			 }else{
				require $_SERVER['DOCUMENT_ROOT'].'/atenea/p/pComunicacionAmpliadaPadrep.php'; 
			 }
...
<div class="col-sm-12 col-lg-12 ">
 ...
 <?php echo $salida; ?>
				...
				<div class="col-sm-12 col-md-12" style="text-align:center; padding:10px; margin:10px;">
                     <a href="https://colegioatenea.es/zona-padres/zona-padres-2/zona-de-comunicacion-2/">
