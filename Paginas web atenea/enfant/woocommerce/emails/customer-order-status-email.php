...
<h2><?php echo esc_html__( 'Pedido:', 'woocommerce-order-status-manager' ) . ' ' . $order->get_order_number(); ?></h2>

<table class="td" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
	<thead>
		<tr>
			<th class="td" scope="col" style="text-align: left;"><?php esc_html_e( 'Producto', 'woocommerce-order-status-manager' ); ?></th>
			<th class="td" scope="col" style="text-align: left;"><?php esc_html_e( 'Cantidad', 'woocommerce-order-status-manager' ); ?></th>
			<th class="td" scope="col" style="text-align: left;"><?php esc_html_e( 'Precio', 'woocommerce-order-status-manager' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
...
<h2><?php esc_html_e( 'Datos del cliente:', 'woocommerce-order-status-manager' ); ?></h2>
...
<?php _e( 'Gracias por tu compra online. Tu pedido listo para el día de la entrega de libros.', 'woocommerce' ); ?>
